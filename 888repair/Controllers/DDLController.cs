...
namespace _888repair.Controllers
{
    ...
    public class DDLController : Controller
    {
        ...
        public ActionResult getBuilding(string keyWord)
        {
            ...
            string sql = "SELECT distinct SystemCategory,Buliding  Building FROM[888_CsNew].[dbo].[area] where 1=1 ";
        ...
        {
            RepairDb db = new RepairDb();
            string sql = "SELECT charge_id, EmpNo, FullName ,UpdateUser,UpdateTime FROM [888_CsNew].[dbo].[charge] where 1=1 ";
            if (!string.IsNullOrEmpty(keyWord))
            {
        ...
        {
            RepairDb db = new RepairDb();
            string sql = "SELECT kind_id KindID,SystemCategory,Sort,KindCategory,Remark FROM[888_CsNew].[dbo].[kind] where 1=1 ";
            if (!string.IsNullOrEmpty(keyWord))
            {
        ...
        {
            RepairDb db = new RepairDb();
            string sql = "SELECT SystemCategory,charge_id, EmpNo, FullName ,UpdateUser,UpdateTime FROM [888_CsNew].[dbo].[charge] where 1=1 ";
            if (!string.IsNullOrEmpty(keyWord))
            {
                sql += " and SystemCategory = @keyWord";
            }
        ...
        {
            RepairDb db = new RepairDb();
            string sql = "SELECT area_id AreaId,SystemCategory,Buliding,Location FROM[888_CsNew].[dbo].[area] where 1=1 ";
            if (!string.IsNullOrEmpty(keyWord))
            {
                sql += " and Buliding = @keyWord";
            }
        ...
        {
            RepairDb db = new RepairDb();
            string sql = "SELECT distinct StatusValue,StatusText FROM [888_CsNew].[dbo].[state] where 1=1 ";
            if (!string.IsNullOrEmpty(keyWord))
            {
                sql += " and SystemCategory = @keyWord";
            }
        ...
        {
            RepairDb db = new RepairDb();
            string sql = "SELECT distinct Location FROM[888_CsNew].[dbo].[area] where 1=1 ";
            var group = Session["GroupName"] == null ? Session["OPGroup"].ToString() : Session["GroupName"].ToString();
            if (!string.IsNullOrEmpty(group))
            {
                switch (group)
